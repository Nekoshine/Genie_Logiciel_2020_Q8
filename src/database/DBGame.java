...
public class DBGame extends DBConnexion {
    ...
    public static boolean deleteGame(int idGame){
        ...
        try{
            ...
            if(resRoom.next()){ // Si il est dans une salle
                boolDelete=false; // on supprime pas
            }
            else {
                ...
                while (res.next()) { // On itère chaque résultat
    ...
    */
    public static GameList getGames(int idUser){
        ...
        try{
            ...
            while (resultat.next()) { // On itère chaque résultat
                // On convertit le booleen car il est stocké comme un entier dans la base
                boolGame= resultat.getBoolean("ready");
     ...
     * @param timerN le temps
     * @param readyN un booleen
     * @return true si ca fonctionne
     */
