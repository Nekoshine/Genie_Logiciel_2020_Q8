...
class DBUserTest {
    ...
    final void testConnectGoodUserGoodPassword() {
        int test = DBUser.connectUser(GOOD_LOGIN, GOOD_PASSWORD, true);
    ...
    final void testConnectGoodUserWrongPassword() {
        int test = DBUser.connectUser(GOOD_LOGIN, WRONG_PASSWORD, true);
    ...
    final void testConnectWrongUserGoodPassword() {
        int test = DBUser.connectUser(WRONG_LOGIN, GOOD_PASSWORD, true);
    ...
    final void testConnectWrongUserWrongPassword() {
        int test = DBUser.connectUser(WRONG_LOGIN, WRONG_PASSWORD, true);
    ...
    final void testInjectionCode(){
        ...
        int test = DBUser.connectUser(login, password, true);
